  ...
  return (
    <>
      ...
      <div className="fixed top-4 left-4 z-50 md:hidden">
        <Button variant="outline" size="icon" onClick={() => setIsOpen(!isOpen)} className="bg-background shadow">
      ...
      <aside className={`fixed left-0 top-0 h-screen w-60 bg-sidebar border-r border-sidebar-border shadow-lg flex flex-col transition-transform duration-300 z-40 md:relative md:translate-x-0 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
        {/* Logo */}
        <div className="flex items-center gap-3 px-5 py-6 border-b border-sidebar-border flex-shrink-0">
        ...
        <div className="px-3 pb-3 flex-shrink-0">
          <div className="rounded-lg bg-gradient-to-br from-primary to-purple-700 p-4 mb-3">
            ...
            <Button size="sm" className="w-full bg-white text-primary hover:bg-white/90 font-semibold text-xs">
              Upgrade Now
            </Button>
          </div>
